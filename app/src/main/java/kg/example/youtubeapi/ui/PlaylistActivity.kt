...
import kg.example.youtubeapi.databinding.ActivityPlaylistsBinding
import kg.example.youtubeapi.result.Status
import kg.example.youtubeapi.utils.CheckConnectionInternet

class PlaylistActivity : BaseActivity<ActivityPlaylistsBinding, PlaylistViewModel>() {
    ...
    override fun inflateVB(layoutInflater: LayoutInflater): ActivityPlaylistsBinding {
